window.addEventListener("scroll", function () {
    ...
    function getTranslateXByWidth(width) {
      const breakpoints = [
        { minWidth: 2500, translateX: "-10.3%" },
        { minWidth: 2400, translateX: "-10.2%" },
        { minWidth: 2100, translateX: "-10.1%" },
        { minWidth: 2000, translateX: "-10.2%" },
        { minWidth: 1800, translateX: "-10.2%" },
        { minWidth: 1800, translateX: "-10.2%" },
        { minWidth: 1700, translateX: "-10.2%" },
        { minWidth: 1600, translateX: "-10.2%" },
        { minWidth: 1500, translateX: "-10.2%" },
        { minWidth: 1300, translateX: "-10.2%" },
        { minWidth: 1200, translateX: "-10.2%" },
        { minWidth: 1179, translateX: "-10.2%" },
